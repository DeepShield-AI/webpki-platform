...
if __name__ == "__main__":
    with app.app_context():
        ...
        scan_args = {
            ...
            'THREAD_WORKLOAD' : 2,
            'INPUT_DOMAIN_LIST_FILE' : r"/root/pki-internet-platform/data/school_domains/cn/cn_edu_20230918",
            'SCAN_PROCESS_NAME': "CN EDU 20241201",
            'STORAGE_DIR' : r"/data/self_scan_data/CN_EDU_20241201",
            'SCAN_TIMEOUT' : 10,
            'MAX_RETRY' : 10,
