...
from backend.config.config_loader import IP_BLACKLIST
...
class InputScanner(Scanner):
    ...
    def start(self):
        ...
        r.set(f"task:{task_id}:start_time", start_time.isoformat())

        # TODO: set unique logger
    ...
    def stream_dispatch_task(self, scan_config : InputScanConfig):
